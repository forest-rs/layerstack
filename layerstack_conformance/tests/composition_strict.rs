...
const KNOWN: &[Known] = &[
    ...
    Known {
        ...
        reason: "classes implied across the relocation of `/Group/Model` to `/Model_Renamed` map to the unrelocated namespace, and `/Rig/Anim/BadRigInstance` still inherits the relocation source `/Rig/RigClass`",
    },
    Known {
        ...
        reason: "classes implied across the relocation of `/Group/Model` map to the unrelocated namespace, and `/Rig/Anim/BadRigInstance` still inherits the relocation source `/Rig/RigClass`",
    },
    Known {
    ...
    Known {
        ...
        values: 0,
        diffs: &[D::Order],
        reason: "the class `group.usd /Group/Model/SymArm` implied into the relocated `/Group_1/Model_1/LArm` ranks before `group.usd /Group/Model/LArm`",
    },
    Known {
