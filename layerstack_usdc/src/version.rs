...
//! [`UsdcError::UnknownValueType`]: crate::UsdcError::UnknownValueType
...
impl CrateVersion {
    ...
    ///
    /// assert!(CrateVersion::new(0, 15, 0).is_readable());
    /// assert!(CrateVersion::new(0, 15, 1).is_readable());
    /// assert!(!CrateVersion::new(0, 16, 0).is_readable());
